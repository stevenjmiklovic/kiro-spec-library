 ...
 */
export async function extractCreatedAt(
  repoPath: string,
  specPath: string,
 ...
 */
export async function extractCompletedAt(
  stage: string,
  repoPath: string,
  specPath: string,
): Promise<string | undefined> {
...
export async function autoPopulate(
  raw: RawSpecArtifacts,
  repoPath: string,
  currentOwner: string,
): Promise<AutoPopulatedFields> {
...
function isCompleted(tasksContent: string | undefined): boolean {
