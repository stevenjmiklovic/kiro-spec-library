...
import { createRelationship, deleteRelationship, checkDuplicate, } from "../db/queries/relationships.js";
import { listPending, acceptSuggestion, rejectSuggestion, } from "../db/queries/suggestions.js";
...
export function relationshipRoutes(deps) {
    const { db } = deps;
    return new Elysia()
        .post("/specs/:id/relationships", ({ params, body, set }) => {
