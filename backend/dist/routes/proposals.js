...
import { createProposal, listPendingProposals, acceptProposal, rejectProposal, getProposal, } from "../db/queries/proposals.js";
import { applyPatch } from "../services/metadata.js";
import { getOverlay } from "../db/queries/metadata.js";
export function proposalRoutes(deps) {
    const { db } = deps;
    return new Elysia()
        // List pending proposals for a spec
        .get("/specs/:id/proposals", ({ params, set }) => {
