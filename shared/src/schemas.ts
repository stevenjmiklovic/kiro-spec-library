...
export const SpecFilterSchema = z.object({
  ...
  type: z.enum(SPEC_TYPES as unknown as [string, ...string[]]).optional(),
  stage: z.enum(LIFECYCLE_STAGES as unknown as [string, ...string[]]).optional(),
  workflow: z.enum(WORKFLOW_TYPES as unknown as [string, ...string[]]).optional(),
...
export const ArchiveFilterSchema = z.object({
  ...
  owner: z.string().optional(),
  repository: z.string().optional(),
  retentionType: z.enum(RETENTION_POLICY_TYPES as unknown as [string, ...string[]]).optional(),
  metadataComplete: z.boolean().optional(),
