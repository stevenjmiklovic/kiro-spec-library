 ...
 */
export function buildSpecsQuery(options) {
 ...
 * clear the filter).
 */
export function useSpecData(options) {
    ...
    const path = useMemo(() => buildSpecsQuery({
 ...
 */
export function useArchiveData(options = {}) {
    const api = useCrewApi();
